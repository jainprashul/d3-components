...
declare const CalibrateMap: ({ xdim, ydim, center: _center, zoom: _zoom, getMapData: getMarkers, size, showAddressInput, apiKey }: Props$1) => JSX.Element;
...
export { CalibrateFloor, CalibrateMap, Coordinates, MapData, imageDimensions };
